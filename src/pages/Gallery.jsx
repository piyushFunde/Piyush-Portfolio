...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Where ambition meets architecture, glowing under a sunset sky 🌇🏛️",
      photos: ["/gallery/Photo_1.png", "/gallery/Photo_4.png"],
    },
    {
      id: 2,
      caption:
        "Lost in the beauty of the misty forest 🌲🌫️",
      photos: ["/gallery/Photo_2.jpeg"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "BedsideBot – Smart healthcare assistant interface.🤖🩺",
      photos: ["/gallery/BedsideBot_Project.png"],
    },
    
    {
      id: 2,
      caption:
        "Expense Tracker Pro – Simple expense management app.💰📊",
      photos: ["/gallery/Photo_3.png"],
    },
  ],
  achievements: [
    // {
